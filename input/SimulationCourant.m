...
%% courbes d'activation et de cin�tique
Vm=[-100:5:50]*1e-3;
cinf=sigmoide(IHC.ICA.xinf,Vm); % courbe d'activation
ctau=cinetique2(IHC.ICA.taux, Vm); % cin�tique d'activation

%% Affiche des courbes de la courbe d'activation et de cin�tique
